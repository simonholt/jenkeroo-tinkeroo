...
pipelineJob('tracetool_labmonitor') {
    displayName('tracetool_labmonitor')
    // description('tracetool_labmonitor')
    ...
    definition {
        cpsScm {
            ...
            scriptPath('cicd/pipelines/imported/tracetool_labmonitor.groovy')
        }
    }
}
