...
pipelineJob('tracetool_devicemgmt') {
    displayName('tracetool_devicemgmt')
    // description('tracetool_devicemgmt')
    ...
    definition {
        cpsScm {
            ...
            scriptPath('cicd/pipelines/imported/tracetool_devicemgmt.groovy')
        }
    }
}
